defmodule GarbanzoBeansWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GarbanzoBeansWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GarbanzoBeansWeb.Gettext, "errors", msg, opts)
    end
  end
